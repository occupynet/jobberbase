					...
					<table border="0" cellspacing="2" cellpadding="2">
						<tr>
							<td colspan="2">
								...
								<label for="type_id_{$types[tmp2].id}"><img src="{$BASE_URL}_templates/{$THEME}/img/icon-{$types[tmp2].var_name}.png" alt="{$types[tmp2].name}" /><span class="{$types[tmp2].var_name} job-type">{$types[tmp2].name}</span></label>
								{/section}&nbsp;&nbsp;
